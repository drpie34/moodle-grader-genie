  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      if (error) {
        ...
        // For testing, create a demo account that doesn't require email verification
        if (values.email.includes('demo') || values.email.includes('test')) {
          console.log("Demo account - not requiring verification");
